...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <div className="w-full bg-background p-12 flex flex-col items-center justify-between transition-all duration-300 border-t-2">
      <div className="flex items-end justify-between w-full">
        ...
        <div className="flex">
          {pages.map((page) => (
            <div key={page.title} className={`flex flex-col ${location === 'home' ? 'mx-8' : 'mx-4'}`}>
      ...
      <div className="flex items-center justify-around text-xs text-gray-700 dark:text-slate-300 mt-16">
